  ...
  let dataProjects = [
    {
      id: 1,
      title: "Project 1",
      des: "Project 1 place holder",
      img: "/p1.svg",
      iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/fm.svg"],
      link: "https://github.com/user-steven",
    },
  ];
  try {
    const { projects } = require("@/config/index");
    dataProjects = projects || dataProjects;
  } catch (error) {
  ...
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-24 gap-y-8 lg:gap-y-24 xl:gap-y-36 p-4 mt-10">
        {dataProjects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
